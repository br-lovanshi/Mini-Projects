...
import com.spring.security.test.SpringSecurityTest.Model.User.JwtRequest;
...
import com.spring.security.test.SpringSecurityTest.security.JwtHelper;
...
public class AuthController {
    ...
    public ResponseEntity<JwtResponse> login(@RequestBody JwtRequest request) {
        ...
        JwtResponse response = JwtResponse.builder()
                .jwtToken(token)
                .jwtUserName(userDetails.getUsername()).build();
